...
import com.deepwelldevelopment.tmos.repack.codechicken.lib.asm.ObfMapping;
import com.deepwelldevelopment.tmos.repack.immibis.bon.JoinMapping;
import com.deepwelldevelopment.tmos.repack.immibis.bon.Mapping;
import com.deepwelldevelopment.tmos.repack.immibis.bon.mcp.CsvFile;
import com.deepwelldevelopment.tmos.repack.immibis.bon.mcp.SrgFile;
...
@Resource
public class TMOSAccessTransformer implements IClassTransformer {

    private static List<String> mapFileList = new LinkedList<String>();

    public TMOSAccessTransformer() throws IOException {
        super();
    ...
    private static class ClassHelper extends SecurityManager {
        ...
        public ClassLoader getClassLoader() {
            ...
            return TMOSLoadingPlugin.loader;
        }
