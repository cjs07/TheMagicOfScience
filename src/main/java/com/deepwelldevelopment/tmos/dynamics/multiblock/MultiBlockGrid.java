...
import com.deepwelldevelopment.tmos.dynamics.core.TickHandler;
import com.deepwelldevelopment.tmos.dynamics.core.WorldGridList;
...
public abstract class MultiBlockGrid {
    ...
    public Set<IMultiBlock> nodeSet = new HashSet<>();
    public Set<IMultiBlock> idleSet = new HashSet<>();
