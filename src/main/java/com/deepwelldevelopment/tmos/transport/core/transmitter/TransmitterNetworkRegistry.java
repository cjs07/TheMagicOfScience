...
import com.deepwelldevelopment.tmos.api.TMOSAPI;
...
public class TransmitterNetworkRegistry {
    ...
    private Logger logger = LogManager.getLogger("TMOSTransmitters");
    ...
    public void removeInvalidTransmitters() {
        if (TMOSAPI.debug && !invalidTransmitters.isEmpty()) {
    ...
    public void assignOrphans() {
        ...
        if (TMOSAPI.debug && !orphanTransmitters.isEmpty()) {
