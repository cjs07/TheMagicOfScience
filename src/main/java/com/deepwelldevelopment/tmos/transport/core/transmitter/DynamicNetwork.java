...
import com.deepwelldevelopment.tmos.api.lib.IClientTicker;
import com.deepwelldevelopment.tmos.lib.util.Coord4D;
import com.deepwelldevelopment.tmos.lib.util.Range4D;
...
public abstract class DynamicNetwork<A, N extends DynamicNetwork<A, N>> implements IClientTicker {
    ...
    public void commit() {
        ...
        if (!changedAcceptors.isEmpty()) {
            for (Map.Entry<IGridTransmitter<A, N>, EnumSet<EnumFacing>> entry : changedAcceptors.entrySet()) {
